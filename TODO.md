...
- [ ] 建立亮色/暗色主题使用的正文、背景、边框和交互状态颜色变量。
- [ ] 为 Markdown 阅读区和代码高亮设计对应的亮色/暗色主题。
- [ ] 完善 Navbar、FileArea 和 ExtendArea 的整体视觉样式。
- [ ] 完善 FileItem 的键盘聚焦和语义，并在主题中统一选中、悬停和聚焦效果。
...
- [ ] 实现文件重命名。
- [ ] 为编辑/阅读模式补充 `aria-pressed` 或等价的 tab 语义。
